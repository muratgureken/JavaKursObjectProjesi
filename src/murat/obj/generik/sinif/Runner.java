...
public class Runner {
	...
	public static void main(String[] args) {
		Hesapla h = new Hesapla(new Object(),4); // Hesapla yanina koseli parantez koymadigimiz icin class bizden default olarak object bekliyor.
		Hesapla<Integer> sayi = new Hesapla<Integer>(3,4);
		sayi.ekle(3,0);
